FROM ubuntu:16.04
MAINTAINER Evgeny Smykov <evgeny.gmail@gmail.com>
ENV DEBIAN_FRONTEND noninteractive

RUN apt-get -qq update && apt-get install -y wget apache2 supervisor libcrypt-ssleay-perl libencode-hanextra-perl libgd-gd2-perl libgd-text-perl libgd-graph-perl libjson-xs-perl liblwp-useragent-determined-perl libmail-imapclient-perl libapache2-mod-perl2 libnet-dns-perl libnet-ldap-perl libpdf-api2-perl libtext-csv-xs-perl libxml-parser-perl libyaml-perl libcrypt-eksblowfish-perl libyaml-libyaml-perl libnet-ldap-perl mysql-server fetchmail libdbi-perl libdbd-mysql-perl libarchive-zip-perl libtemplate-perl
...
# Set OTRS cron jobs
#RUN su otrsserviceuser -c "/opt/otrs/bin/Cron.sh start"
